    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="iagoSurvey">
                    <p class="survey-question">(2) Would you negotiate with this opponent again?</p>
                    <div class="survey-form-item">
                        <input class="iagoCheckableQuestion" type="radio" name="again" id="again1" value="1">
                        <label>Never!</label>
                    </div>
                    <div class="survey-form-item">
                        <input class="iagoCheckableQuestion" type="radio" name="again" id="again2" value="2">
                    </div>
                    <div class="survey-form-item">
                        <input class="iagoCheckableQuestion" type="radio" name="again" id="again3" value="3">
                    </div>
                    <div class="survey-form-item">
                        <input class="iagoCheckableQuestion" type="radio" name="again" id="again4" value="4">
                    </div>
                    <div class="survey-form-item">
                        <input class="iagoCheckableQuestion" type="radio" name="again" id="again5" value="5">
                    </div>
                    <div class="survey-form-item">
                        <input class="iagoCheckableQuestion" type="radio" name="again" id="again6" value="6">
                    </div>
                    <div class="survey-form-item">
                        <input class="iagoCheckableQuestion" type="radio" name="again" id="again7" value="7">
